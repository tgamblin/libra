...
extern "C" {
  ...
  {{foreachfn fn_name MPI_Alltoall MPI_Allgather MPI_Allgatherv MPI_Allreduce MPI_Bcast MPI_Gather MPI_Gatherv MPI_Reduce MPI_Reduce_scatter MPI_Scan MPI_Scatterv MPI_Waitall MPI_Waitany}}
...
#endif
    effort_enter_comm();
    int return_value = P{{fn_name}}{{argList}};
    effort_exit_comm();
    return return_value;
  }
  {{endforeachfn}}
